    ...
    if (app) {
      ...
      for (var i=0, l=app.spaces.length; i<l; i++) {
        ...
        if (space_i.drawIfValue) {
          ...
          if (space_i.type === "R2") {
            ctx.drawImage(space_i.backCanvas, space_i.x, space_i.y);
...
var descartesJS = (function(descartesJS) {
  ...
  descartesJS.Color.prototype.getColorExp = function() {
    ...
    this.r = MathFloor(evaluator.eval(this.rExpr) * 255);
    this.g = MathFloor(evaluator.eval(this.gExpr) * 255);
    this.b = MathFloor(evaluator.eval(this.bExpr) * 255);
...
//     this.name = "";
  ...
  descartesJS.Control.prototype.getScreenshot = function() {
    ...
    ctx.font = self.fieldFontSize + "px Arial, Helvetica, Sans-serif";
...
var descartesJS = (function(descartesJS) {
  ...
  descartesJS.Button.prototype.init = function(force) {
    ...
    if (this.customStyle) {
      ...
      else if (this.conStyle.font == "icons") {
  ...
  descartesJS.Button.prototype.draw = function(force) {
    ...
    imageSrc = evaluator.eval(this.imageSrc) + "";
...
var descartesJS = (function(descartesJS) {
  ...
  descartesJS.Space3D = function(parent, values) {
    ...
    // self.backCtx = self.backCanvas.getContext("2d");
    // self.backCtx.imageSmoothingEnabled = false;
...
var descartesJS = (function(descartesJS) {
  ...
  descartesJS.DescartesLoader = function(descartesApp) {
    ...
    var imageURL = (descartesApp.imgLoader) ? descartesApp.imgLoader : drawDescartesLogo(descartesApp.loader.width, descartesApp.loader.height);
  ...
  var drawDescartesLogo = function(w, h) {
    var canvas = document.createElement("canvas");
    var ratio = ((w*this.descartesApp * h*this.descartesApp) > 5000000) ? 1 : this.descartesApp;
