var secciones = {
	...
	porque: {
		...
		yo: 'lo digo yo',
		caro: 'es muy caro',
		peleaste: 'te peleaste',
		no: 'no'
	},
	postura: {
		frases: {
			'opinion': ' <span class="blank marcador opinion" data-blank="1">En mi opinión, </span>...',
			'opino': ' <span class="blank marcador opinion" data-blank="1">Yo opino que </span>...',
			'creo': ' <span class="blank marcador opinion" data-blank="1">Yo creo que </span>...',
			'considero': ' <span class="blank marcador opinion" data-blank="1">Yo considero que </span>...',
			'pienso': ' <span class="blank marcador opinion" data-blank="1">Yo pienso que </span>...',
			'segun': ' <span class="blank marcador opinion" data-blank="1">Según yo, </span>...',
			'para': ' <span class="blank marcador opinion" data-blank="1">Para mí, </span>...',
			'parecer': ' <span class="blank marcador opinion" data-blank="1">A mi parecer, </span>...',
			'manera': ' <span class="blank marcador opinion" data-blank="1">A mi manera de ver, </span>...',
			'punto': ' <span class="blank marcador opinion" data-blank="1">Desde mi punto de vista, </span>...',
			'parece': ' <span class="blank marcador opinion" data-blank="1">Me parece que </span>...',
			'perspectiva': ' <span class="blank marcador opinion" data-blank="1">Desde mi perspectiva, </span>...'
		},
		posturas: {
	...
	enlace: {
		opciones: [
			"<span class='blank oracion introArg' data-blank='2'>Para probar esto, voy a presentar tres argumentos.</span>",
			"<span class='blank oracion introArg' data-blank='2'>A continuación presento tres argumentos que apoyan esta idea.</span>",
			"<span class='blank oracion introArg' data-blank='2'>Enseguida mencionaré tres ideas que muestran la validez de esta apreciación.</span>"
		],
		chosen: false,
		rebuildValue: ""
	},
	argumentos: {
		...
		datos: {
			noEsJusto: [
				"<span class='blank conector ejemplo' data-blank='3'>Por ejemplo,</span> Sandra y Ana son hermanas y salen todo el tiempo juntas. Sandra tiene buenas calificaciones y Ana no. <span class='blank conector adicion' data-blank='4'>También</span> está el caso de Alonso y Alberto. Ellos trabajan en el taller mecánico de su papá todas las tardes. Uno tiene las mejores calificaciones del salón y el otro las peores. ",
				"<span class='blank marcador hecho' data-blank='8'>Por ejemplo, todo mundo sabe que</span> los adultos que trabajan tienen derecho por ley a varios días de vacaciones al año. El caso de los niños es parecido. En la Constitución dice que tenemos derecho al descanso y al esparcimiento (artículo 13). ",
				"<span class='blank conector ejemplo'>Por ejemplo,</span> cuando vas de fiesta o de viaje con amigos, tienes muchas anécdotas nuevas que contar. <span class='blank conector contraste' data-blank='5'>En cambio,</span> si nunca sales no aprendes a convivir en grupo y puede ser más difícil hacer amigos. ",
				"Toño es el ejemplo perfecto. Su mamá le enseñó cómo tomar el camión y qué hacer si se pierde. Ahora él se regresa solo a casa. <span class='blank conector contraste' data-blank='5'>En cambio,</span> Pedro se perdió el otro día en la calle y no pudo regresar a su casa. Nadie le había enseñado. "
			],
			noConviene: [
				"<span class='blank conector ejemplo' data-blank='3'>Por ejemplo,</span> los papás de Sebastián no sabían manejar y él aprendió con un amigo suyo. <span class='blank conector adicion' data-blank='4'>También</span> está el caso de Mariana. Sus amigas siempre le ayudan a estudiar para su examen de matemáticas. ",
				"<span class='blank marcador hecho' data-blank='8'>Es un hecho que</span> los papás no pueden estar contigo todo el tiempo. Si te pasa algo malo en la escuela, tus amigos te pueden proteger. <span class='blank conector adicion' data-blank='4'>Además, </span> cuando estás triste, no siempre quieres hablar con tus papás pero sí con tus amigos. ",
				"<span class='blank conector ejemplo' data-blank='3'>Por ejemplo,</span> está el caso de Toño. Su mamá le enseñó cómo tomar el camión y qué hacer si se pierde. Ahora él se regresa solo a casa. <span class='blank conector contraste' data-blank='5'>En cambio,</span> Pedro se perdió el otro día en la calle y no pudo regresar a su casa. Nadie le había enseñado. ",
				"<span class='blank marcador hecho' data-blank='6'>Está probado que</span> un niño que no convive con gente de su edad, tendrá dificultades de integrarse a un equipo de trabajo. <span class='blank conector adicion' data-blank='4'>También</span> <span class='blank marcador hecho' data-blank='6'>se ha visto que</span> quien convive con más gente en la infancia podrá encontrar pareja más fácilmente cuando sea grande. "
			],
			afectaLaSalud: [
				"<span class='blank conector ejemplo' data-blank='3'>Por ejemplo,</span> <span class='blank marcador hecho' data-blank='6'>se ha demostrado que</span> los niños que se quedan en casa ven la tele o juegan en la computadora. Esto va en contra de las recomendación de la Organización Mundial de la Salud de hacer cuando menos 60 minutos de ejercicio al día. ",
				"<span class='blank marcador hecho' data-blank='8'>Es un hecho que</span> los papás no pueden estar contigo todo el tiempo. Si te pasa algo malo en la escuela, tus amigos te pueden proteger. <span class='blank conector adicion' data-blank='4'>También</span> cuando estás triste, no siempre quieres hablar con tus papás pero sí con tus amigos. ",
				"<span class='blank conector ejemplo' data-blank='3'>Por ejemplo,</span> se ha probado que los niveles de estrés bajan considerablemente después de un ataque de risa. <span class='blank conector contraste' data-blank='5'>En cambio,</span> <span class='blank marcador hecho' data-blank='6'>se ha estudiado que</span> las personas que no se relajan en sus trabajos tienen mayores probabilidades de enfermarse. ",
				"<span class='blank marcador hecho' data-blank='6'>Está probado que</span> un niño que no convive con gente de su edad, tendrá dificultades de integrarse a un equipo de trabajo. <span class='blank conector adicion' data-blank='4'>Además,</span> <span class='blank marcador hecho' data-blank='6'>se ha visto que</span> quien convive con más gente en la infancia podrá encontrar pareja más fácilmente cuando sea grande. "	
			]	
		},
		chosen: 0,
		rebuildValue: []
	...
	conclusion: {
		frases: {
			'todoLoAnterior': ' <span class="blank oracion conclu" data-blank="7">Todo lo anterior pone en evidencia que</span> ',
			'esPor': ' <span class="blank oracion conclu" data-blank="7">Es por todo eso que</span> ',
			'lasRazones': ' <span class="blank oracion conclu" data-blank="7">Las razones expuestas nos permiten concluir que</span> '
		},
		opciones: [
			...
			" el desarrollo infantil se ve favorecido con la diversión y el esparcimiento. Impedir lo anterior podría traer consecuencias negativas de largo plazo para las niñas y los niños."
		],
		chosen: false,
		rebuildValue: ""
	}
...
Argumentacion.prototype = {
		...
		init:function(){
			...
			$('div.pestanya').on("click",function(){
				...
				if(seccion == "argumentos"){
					if($('span[data-id="datos"]').length==2){
						_this.setSeccion($(this).data('id'),false); 
					} else {
						_this.setSeccion($(this).data('id'),true); 
					}
				} else
				if(seccion == "conclusion"){
					if($('span[data-id="conclusion"]').length==0 && $('span[data-id="frase_conclusion"]').length==1){
						_this.setSeccion($(this).data('id'),true); 
					} else {
						_this.setSeccion($(this).data('id'),false); 
					}
				...
				if(seccion == "presentacion"){
					if($('span[data-id="presentacion"]').length==1){
						_this.setSeccion($(this).data('id'),false); 
					} else {
						_this.setSeccion($(this).data('id'),true); 
					}
		...
		addFraseConclu: function(key){
			$('div.divParrafo').removeClass('e-navegando');
			var txt = this.secciones.conclusion.frases[key];
		...
		textoFinal: function(){
			...
			$('span[data-id="enlace"]').html($('span[data-id="enlace"]').html()+"<br><br>");
			$('span[data-id="frase_conclusion"]').html("<br><br>"+ $('span[data-id="frase_conclusion"]').html());
			var texto = this.convertStr(this.$parrafo.html());
			this.addMwSettings("textoCompleto",texto);
			//alert(texto);
		},
